...
<style>
	*{ -webkit-font-smoothing:antialiased; }
	...
	.card { background: #fff; border: 1px solid #e7e5e4; border-radius: 16px; padding: 2.5rem; max-width: 30rem; text-align: center; box-shadow: 0 1px 2px rgba(0,0,0,.05); }
	...
	.detail { background: #f5f5f4; border: 1px solid #e7e5e4; border-radius: 10px; padding: 1rem 1.2rem; font-size: .8rem; color: #78716c; text-align: left; margin-bottom: 1.5rem; overflow-wrap: anywhere; }
...
<body>
	<main>
		<div class="card">
			...
			<h1>We hit a snag</h1>
			<p>Something went wrong on our side while talking to the database. The issue has been noted — if it keeps happening, please get in touch.</p>
			<div class="detail"><?= is_string($message) ? html_escape($message) : '' ?></div>
			<div class="actions">
